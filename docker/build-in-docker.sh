...
cd gnustep-base-1.28.20221209 && rm -rf !\("debian"\) && tar -xvzf ../gnustep-base_1.28.20221209.orig.tar.gz --strip-components=1 && DEB_BUILD_OPTIONS=nocheck debuild -us -uc && cd ..
